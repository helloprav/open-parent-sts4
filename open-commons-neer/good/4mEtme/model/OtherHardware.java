...
/**
 * The persistent class for the OtherHardwares database table.
 * 
 */
@Entity
@Table(name="OtherHardwares")
@NamedQuery(name="OtherHardware.findAll", query="SELECT n FROM OtherHardware n")
public class OtherHardware implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private int otherHardwareID;
	...
	public int getOtherHardwareID() {
		return this.otherHardwareID;
	}

	public void setOtherHardwareID(int otherHardwareID) {
		this.otherHardwareID = otherHardwareID;
	}

	public String getOtherHardwareName() {
		return this.otherHardwareName;
	}
