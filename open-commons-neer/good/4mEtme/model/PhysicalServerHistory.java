...
/**
 * The persistent class for the PhysicalServerHistory database table.
 * 
 */
@Entity
@Table(name = "PhysicalServerHistory")
@NamedQuery(name = "PhysicalServerHistory.findAll", query = "SELECT ph FROM PhysicalServerHistory ph")
public class PhysicalServerHistory implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int physicalServerHistoryID;
	...
	public PhysicalServerHistory() {
		super();
		// TODO Auto-generated constructor stub
	}

	public int getPhysicalServerHistoryID() {
		return physicalServerHistoryID;
	}

	public void setPhysicalServerHistoryID(int physicalServerHistoryID) {
		this.physicalServerHistoryID = physicalServerHistoryID;
	}
